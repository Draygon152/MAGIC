...
public class NsquelsnaakBehavior : EnemyBehaviorBase
{
    ...
    [SerializeField] private EnemyBehaviorBase larvaPrefab; //The prefab for spawning the larve
    [SerializeField] private int spawnTime = 3;             //The time between spawning of larve
    [SerializeField] private int spawnAmount = 3;           //The amount of larva that will spawn each time
    [SerializeField] private float spawnRange = 3.0f;       //The maximun range for spawing the larva
